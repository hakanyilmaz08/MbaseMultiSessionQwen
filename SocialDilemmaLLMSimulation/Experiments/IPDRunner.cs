...
public class IPDRunner : RepeatedGameRunnerBase
{
    ...
    private const int Punishment = 1;
    private const int Sucker = 0;
...
""".Trim())
    ...
    protected override string PrettyGameName => "IPD";
    protected override string DecisionGameCode => "PD";
    protected override string UniqueNameGameCode => "IPD";
